...
import { com, google } from '../build/proto'

import api = com.example.inventory
import domain = com.example.inventory.persistence

const EventSourced = cloudstate.EventSourced

type Empty = google.protobuf.IEmpty

export const entity = new EventSourced(
    [
        "com/example/inventory/inventory.proto",
        "com/example/inventory/persistence/domain.proto"
    ],
...
const pkg = "com.example.inventory.persistence."
const ProductInventory = entity.lookupType(pkg + "ProductInventory") as typeof domain.ProductInventory
const AvailableInventoryChanged = entity.lookupType(pkg + "AvailableInventoryChanged") as typeof domain.AvailableInventoryChanged
const ProductReserved = entity.lookupType(pkg + "ProductReserved") as typeof domain.ProductReserved
const ProductReservationCancelled = entity.lookupType(pkg + "ProductReservationCancelled") as typeof domain.ProductReservationCancelled
const ProductBought = entity.lookupType(pkg + "ProductBought") as typeof domain.ProductBought
